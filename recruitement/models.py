...
class user_workstatus(models.Model):
    ...
    duration_to_year=models.IntegerField(blank=True,null=True)
    duration_to_month=models.IntegerField(blank=True,null=True)
...
class user_personalinfo(models.Model):
    ...
    reasonforbreak=models.CharField(max_length=150,blank=True,null=True)
...
class user_certification(models.Model):
    ...
    certification_validity_from_year=models.IntegerField()
    certification_validity_from_month=models.IntegerField()
    certification_validity_to_year=models.IntegerField(blank=True,null=True)
    certification_validity_to_month=models.IntegerField(blank=True,null=True)
...
class employment(models.Model):
    user_account_id = models.ForeignKey('user_account',related_name='user_account_id_employment', on_delete=models.CASCADE,default=None)
...
class patent(models.Model):
    ...
    issue_date_month=models.IntegerField(blank=True,null=True)
    issue_date_year=models.IntegerField(blank=True,null=True)
    description=models.CharField(max_length=400)
    createdDate = models.DateTimeField(auto_now_add=True, blank=True)
    modifiedDate = models.DateTimeField(auto_now=True)